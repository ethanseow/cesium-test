...
time = input_dict['time'] # isot format
prop_dur = input_dict['prop_dur'] # days
dist_threshold = input_dict['dist_threshold']
elev_threshold = input_dict['elev_threshold'] # needed with GS_pos
conicSensorAngle = input_dict['conicSensorAngle'] 
GS_pos = input_dict['GS_pos'] # [[1,2], [3,4]]

"""
input_dict = {'i': 60, 't': 6, 'p': 2, 'f': 1, 'alt': 600, 'time': '2022-06-08T00:00:00', 'prop_dur': 1, 'dist_threshold': None, 'elev_threshold': None, 'conicSensorAngle': None, 'GS_pos': [[10, 10], [40, 40], [60, 60], [100, 100], [150, 150]]}
"""
